...
export const BalancerV1_MMR: BalanceProvider = (mmr, wrLast20Games, gamesPlayed) => {
  ...
  return mmrScore * winrateFactor * educationFactor * experienceFactor;
}

export const BalancerV2_MMR: BalanceProvider = (mmr, wrLast20Games, gamesPlayed) => {
  ...
  return mmrScore * educationFactor * experienceFactor;
}
